...
@login_required
def oj_standing(request):
    standings = OJStanding.objects.all().order_by('-total_submission')
    profiles = UserProfile.objects.all()
    return render(request,'App_Login/standing2.html', context={'standings':standings,'profiles':profiles})
